...
dataset_folder = "/Users/fredericbusch/Desktop/Thesis/forks/collection_of_results/wikielections_combined/real/wikielections"
...
cx_path_real = os.path.join(real_folder, "cx", "e=False p=False l=15 s=500", "cx_0_combined.csv")
cx_path_null = os.path.join(null_folder, "cx", "e=False p=False l=15 s=500", "cx_0_combined.csv")

pyr_path_real = os.path.join(real_folder, "pyr", "s=1500 sp=None", "pyr_0_combined.csv")
pyr_path_null = os.path.join(null_folder, "pyr", "s=1500 sp=None", "pyr_0_combined.csv")
