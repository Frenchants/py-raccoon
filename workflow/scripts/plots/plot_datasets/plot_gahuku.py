...
cx_path_real = os.path.join(real_folder, "cx", "e=True p=False l=15 s=1", "cx_0_combined.csv")
cx_path_null = os.path.join(null_folder, "cx", "e=True p=False l=15 s=1", "cx_0_combined.csv")

pyr_path_real = os.path.join(real_folder, "pyr", "s=10000 sp=None", "pyr_0_combined.csv")
pyr_path_null = os.path.join(null_folder, "pyr", "s=10000 sp=None", "pyr_0_combined.csv")
...
plt.plot(cx_real_k_values[:until_value], cx_real_values[:until_value], marker='o', label='Exact CX', color='red')
plt.plot(cx_null_k_values[:until_value], cx_null_values[:until_value], marker='o', label='Exact CX null model', color='grey')
